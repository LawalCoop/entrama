...
/**
 * `/live` lleva al slide deck de FACTTIC.
 *
 * Los archivos viven en `public/live/` (ver `docs/live.md`), y Next sirve
 * `public/` por ruta exacta: `/live/index.html` anda solo, pero `/live` a secas
 ...
 * redirect lleva la barra a `/live/index.html`, donde lo relativo cae bien —y
 * sigue estando bien si mañana esa copia suma un asset relativo más.
 */
const nextConfig: NextConfig = {
  redirects: async () => [
    { source: '/live', destination: '/live/index.html', permanent: false },
  ],
}
